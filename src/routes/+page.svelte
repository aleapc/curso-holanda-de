...
<section class="mt-2">
  ...
  <p class="mt-1 text-carvao/70">
    Niederländisch und Kultur, um in den Niederlanden zurechtzukommen — hören, laut mitsprechen, und
...
>
  ...
  <span class="min-w-0 flex-1">
    ...
    <span class="block text-xs text-carvao/60"
      >Get <b>Google Translate</b> and download <b>German</b> for offline use — the camera reads
