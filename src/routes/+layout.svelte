  ...
  >
    <div class="flex items-center justify-between gap-2">
      <a href="{base}/" class="flex items-baseline gap-1.5">
        <span class="text-lg font-extrabold text-terracota">Zeg het maar!</span>
        <span class="hidden text-xs font-medium text-carvao/50 sm:inline">· Niederländisch für unterwegs</span>
      </a>
